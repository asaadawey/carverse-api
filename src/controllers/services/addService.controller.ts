...
export const addServiceSchema: yup.SchemaOf<{ body: AddServiceRequestBody }> = yup.object({
...
const addService: RequestHandler<AddServiceParams, AddServiceResponse, AddServiceRequestBody, AddServiceQuery> = async (
  req,
  res,
  next,
) => {
