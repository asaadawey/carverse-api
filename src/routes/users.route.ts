...
import { loginController, registerController, checkUserExistController, getUserDetailsController, addDeleteRequestController, processDeleteRequestController } from 'src/controllers/users';
